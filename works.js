document.addEventListener('DOMContentLoaded', () => {
    ...
    const youtubeIds = {
        ...
        cannons: 'Uk_HWMKICVU',
        paristexas: 'tL2QPNxr4NY',
        'noel-philly': 'kOr-6L4gnhg',
        lunartide: 'XE_xmQBKjC0',
        pdm: 'vuzTTcA_8BQ',
        carlcox: 'sUgH5BM_T8c',
    ...
    const openPlaceholder = (item, subtitle = 'Video coming soon.') => {
        ...
        const title = spanText && h3Text ? `${spanText} — ${h3Text}` : (h3Text || spanText || 'Work');
        youtubeContainer.innerHTML = `
            <div style="display:flex;align-items:center;justify-content:center;min-height:50vh;width:100%;">
                <div style="text-align:center;max-width:720px;padding:24px;">
                    <div style="font-size:32px;line-height:1.1;margin-bottom:10px;">${title}</div>
                    <div style="opacity:0.85;font-size:16px;">${subtitle}</div>
                </div>
            </div>
        `;
    ...
    gridItems.forEach((item, index) => {
        ...
        item.addEventListener('click', function(e) {
            ...
            if (workId === 'limperatrice') {
                ...
                const vimeoId = vimeoIds.limperatrice || '1053953559';
            ...
            // LYNY entry - Vimeo popup
                ...
                const vimeoId = vimeoIds.lyny || '1044435127';
                const iframe = `<iframe src="https://player.vimeo.com/video/${vimeoId}?autoplay=1" allow="autoplay; fullscreen"></iframe>`;
                ...
                const igPermalink = 'https://www.instagram.com/reel/DTLq2vHEuaF/';
                ...
                instagramContainer.innerHTML = `
                    <div class="instagram-post">
                        ...
                        <iframe src="${igEmbedUrl}" allowtransparency="true" allowfullscreen="true" frameborder="0" scrolling="no" style="position:absolute;inset:0;width:100%;height:100%;border:0;z-index:1;background:#fff;"></iframe>
                    </div>
                ...
                script.onload = () => {
                    ...
                    setTimeout(() => {
                        ...
                        if (instagramPost) {
                            instagramPost.style.margin = '0 auto';
            ...
            // Special handling for Bob Moses - Instagram popup
            else if (workId === 'bobmoses') {
                ...
                script.onload = () => {
                    ...
                    // Add additional centering for Instagram post after loading
                    setTimeout(() => {
                        const instagramPost = document.querySelector('.instagram-post');
                        if (instagramPost) {
                            instagramPost.style.margin = '0 auto';
                            instagramPost.style.display = 'block';
                            console.log('Applied additional centering to Instagram post');
                        }
                    }, 500);
                };
            ...
            // Summer Smash entry - Instagram modal with two posts side by side
                ...
                setTimeout(() => {
                    ...
                    script.onload = () => {
                        ...
                        // Add additional centering for Instagram posts after loading
                        setTimeout(() => {
                            ...
                            console.log('Applied additional centering to Summer Smash Instagram posts');
                        }, 500);
                    };
                ...
                const youtubeId = youtubeIds[workId];
                if (!youtubeId) {
